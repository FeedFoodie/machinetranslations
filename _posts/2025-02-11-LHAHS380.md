...
"The rule among mercenaries is simple. No matter how many people are involved in the hunt, the ones who find the prey first take all the rewards. Even if we help, we won't get a single coin. However if we refuse to fight, we'll only get scorned."
